	...
	?>
        <div class="col-md-3">
            <div class="widget widget-chart white-bg padding-0">
                ...
                <div class="widget-content">
                    <h3 class="margin-b-10 text-success"><b><?php echo $online; ?></b> <small
                            class="text-muted">ZİYARETÇİ</small></h3>
        ...
        <div class="col-md-3">
            <div class="widget widget-chart white-bg padding-0">
                ...
                <div class="widget-content">
                    <h3 class="margin-b-10  text-primary"><b><?php echo $bugun_tekil ?></b> <small
                            class="text-muted">ZİYARETÇİ</small></h3>
                    <h3 class="margin-b-10  text-primary"><b><?php echo $bugun_cogul ?></b> <small
                            class="text-muted">GÖSTERİM</small></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="widget widget-chart white-bg padding-0">
                ...
                <div class="widget-content">
                    <h3 class="margin-b-10 text-warning"><b><?php echo $buay_tekil ?></b> <small
                            class="text-muted">ZİYARETÇİ</small></h3>
                    <h3 class="margin-b-10 text-warning"><b><?php echo $buay_cogul ?></b> <small
                            class="text-muted">GÖSTERİM</small></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="widget widget-chart white-bg padding-0">
                ...
                <div class="widget-content">
                    <h3 class="margin-b-10 text-danger"><b><?php echo $toplam_tekil ?></b> <small
                            class="text-muted">ZİYARETÇİ</small></h3>
                    <h3 class="margin-b-10 text-danger"><b><?php echo $toplam_cogul ?></b> <small
                            class="text-muted">GÖSTERİM</small></h3>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="mesaj-detay.php?mesaj_id=<?php echo $mesajprint['mesaj_id']; ?>"
                                        title="Göster" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a>
                                    <a href="controller/function.php?mesajsil=ok&mesaj_id=<?php echo $mesajprint['mesaj_id']; ?>"
