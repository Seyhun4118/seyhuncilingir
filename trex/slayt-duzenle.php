            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form method="POST" action="controller/function.php" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            <input type="hidden" name="eski_yol_mobil" value="<?php echo $slaytwrite['mobil']; ?>">
                        </div>
                        <div class="form-group">
                            <label>Slayt Başlık</label>
                            <input type="text" name="slayt_baslik" value="<?php echo $slaytwrite['slayt_baslik']; ?>"
                                class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="5"
                                name="slayt_aciklama"><?php echo $slaytwrite['slayt_aciklama']; ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Yüklü Resim</label>
                            <p><img style="max-height: 100px;max-width: 100px;"
                                    src="<?php echo $slaytwrite['slayt_resim']; ?>"></p>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Mobil Yüklü Resim</label>
                            <p><img style="max-height: 100px;max-width: 100px;"
                                    src="<?php echo $slaytwrite['mobil']; ?>"></p>
                        </div>
                        <div class="form-group">
                            <div class="fileinput fileinput-new input-group col-md-3" data-provides="fileinput">
                                <div class="form-control" data-trigger="fileinput"><span
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slayt_renk" value="<?php echo $slaytwrite['slayt_renk']; ?>"
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Botun Adı</label>
                            <input type="text" name="slayt_butonad" value="<?php echo $slaytwrite['slayt_butonad']; ?>"
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Botun Link</label>
                            <input type="text" name="slayt_butonlink"
                                value="<?php echo $slaytwrite['slayt_butonlink']; ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Slayt Sıra</label>
                            <input type="text" name="slayt_sira" value="<?php echo $slaytwrite['slayt_sira']; ?>"
                                class="form-control">
                        </div>
                        <button style="cursor: pointer;" type="submit" name="slaytduzenle"
