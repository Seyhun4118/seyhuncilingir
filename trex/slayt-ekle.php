        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="controller/function.php"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slayt_butonad" placeholder="Buton adı giriniz."
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Botun Link</label>
                            <input type="text" name="slayt_butonlink" placeholder="Buton linki giriniz."
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Slayt Sıra</label>
                            <input type="text" name="slayt_sira" placeholder="Salyt sırası belirtiniz."
                                class="form-control">
                        </div>
                        <button style="cursor: pointer;" type="submit" name="slaytekle"
                            class="btn btn-success btn-icon"><i class="fa fa-floppy-o "></i>Kaydet</button>
                    </form>
                </div>
            </div>
        </div>
