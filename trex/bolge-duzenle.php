                ...
                <div class="card-block">
                    ...
                    <form method="POST" action="controller/function.php" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="proje_baslik" value="<?php echo $projewrite['proje_baslik']; ?>"
                                class="form-control">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="proje_kategori" class="form-control m-b">
								...
								?>
                                <option value="<?php echo $kategoriwrite['kategori_id'] ?>">
                                    <?php echo $kategoriwrite['kategori_ad'] ?></option>
                                <?php 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="summernote"
                                name="proje_icerik"><?php echo $projewrite['proje_icerik']; ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Bölge Resim</label>
                            <p><img style="max-height: 100px;max-width: 100px;"
                                    src="<?php echo $projewrite['proje_resim']; ?>"></p>
                        ...
                        <div class="">
                            ...
                            <p class="text-muted">Google başta olmak üzere tüm arama motorları sizi buraya girdiğiniz
                                bilgiler doğrultusunda üst sıralara taşıyacaktır.</p>
                        </div>
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" name="proje_title" value="<?php echo $projewrite['proje_title']; ?>"
                                class="form-control form-control-rounded">
                        </div>

                        <div class="form-group">
                            <label>Description</label>
                            <input name="proje_descr" type="text" value="<?php echo $projewrite['proje_descr']; ?>"
                                class="form-control form-control-rounded">
                        </div>

                        <div class="form-group">
                            <label>Keywords</label>
                            <input type="text" name="proje_keyword" value="<?php echo $projewrite['proje_keyword']; ?>"
                                class="form-control form-control-rounded">
                            <small class="text-muted">Örnek : <code>elma, armut, muz, karpuz</code></small>
                        </div>
                        <button style="cursor: pointer;" type="submit" name="bolgeduzenle"
