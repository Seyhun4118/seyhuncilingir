                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="omenu_ust" class="form-control m-b">
                                        ...
                                        <option <?php if ($omenuprint['omenu_ust']==$menulistprintx['omenu_id']) { echo "selected"; } ?> value="<?php echo $menulistprintx['omenu_id']; ?>"><?php echo $menulistprintx['omenu_ad']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-2">
